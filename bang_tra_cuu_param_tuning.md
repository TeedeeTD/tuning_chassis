...
| `ATC_STR_ANG_P` | `2.0` | 1/s | Hệ số P chuyển đổi giữa góc hướng bám và tốc độ bẻ lái | Tăng: Chuyển hướng ôm cua gắt hơn. Giảm: Ôm cua mềm êm hơn. Quá cao: Rắn bò | Cài 1.2 - 2.0 cho Ackermann |
...
| `WP_PIVOT_ANGLE` | `45` | Độ (°) | Góc bẻ lái tối thiểu để phân loại cua nông vs cua gắt | Góc < PIVOT_ANGLE: Cắt cua mượt giữ tốc độ. Góc >= PIVOT_ANGLE: Giảm tốc dừng/rẽ | 45° giúp phân loại góc rẽ |
| `ATC_TURN_MAX_G` | `0.3` | G | Gia tốc ly tâm (gia tốc ngang) tối đa cho phép khi rẽ cua | Tăng: Giữ tốc độ cao khi rẽ cua. Giảm: Ép hãm giảm tốc độ dài khi vào cua gắt | V_cua = sqrt(ATC_TURN_MAX_G * 9.81 * R) |
...
| `AVOID_MARGIN` | `1.0` | m | Khoảng cách lề an toàn phanh dừng trước vật cản | Tăng: Dừng xa vật cản hơn. Giảm: Đứng sát vật cản hơn | Khoảng cách dừng trước vật cản |
